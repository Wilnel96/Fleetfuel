-- Set search path to ensure tables are found
SET search_path TO public;

-- Verify garages table exists
DO $$
BEGIN
  IF NOT EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'garages') THEN
    RAISE EXCEPTION 'garages table does not exist in public schema';
  END IF;
END $$;
