...
export default function CustomReportBuilder({ onNavigate }: CustomReportBuilderProps) {
  ...
  const getDefaultColumns = (tableName: string, filterForClient: boolean = false): TableColumn[] => {
    const columnMap: Record<string, TableColumn[]> = {
      ...
      'organizations': [
        ...
        { name: 'billing_contact_phone_mobile', type: 'string' },
        { name: 'billing_contact_phone_office', type: 'string' },
  ...
  const getReadableColumnName = (columnName: string): string => {
    const columnNameMap: Record<string, string> = {
      ...
      'billing_contact_surname': 'Billing Contact Surname',
      'billing_contact_email': 'Billing Contact Email',
      'billing_contact_phone_mobile': 'Billing Contact Mobile',
      'billing_contact_phone_office': 'Billing Contact Office Phone',
